...
{
public:
	KochSnowflake(sf::Vector2f pa, sf::Vector2f pb, sf::RenderWindow* window, float scale = 1, sf::Vector2f origin = sf::Vector2f(0, 0)) :
...
private:
	...
	void recurse(const sf::Vector2f end_point, int limit);
	void transfromLine();
};
